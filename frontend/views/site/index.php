...
<div class="site-index">
            ...
            <div class="fullwidthbanner">
                <ul>
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-saveperformance="on">
                        <!--MAIN IMAGE-->
                        <img src="dev/img/slider/slider1.jpg" alt="" data-bgposition="center top" data-duration=""
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-saveperformance="on">
                        <!--MAIN IMAGE-->
                        <img src="dev/img/slider/slider6_2.jpg" alt="" data-bgposition="center center" data-duration=""
                            data-ease="Power0.easeInOut" data-bgfit="cover" data-bgrepeat="no-repeat" />
                        <!-- LAYER NR. -->
                        <div class="tp-caption skewfromrightshort skewtorightshort tp-resizeme" data-x="center"
                            data-hoffset="0" data-y="center" data-voffset="-150" data-speed="500" data-start="500"
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a href="#"><span>
                            <img src="dev/img/banner/banner-14.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
                <!-- single-banner start -->
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a class="last-banner" href="#"><span>
                            <img src="dev/img/banner/banner-15.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
                <!-- single-banner start -->
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a href="#"><span>
                            <img src="dev/img/banner/banner-16.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
                <!-- single-banner start -->
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a class="last-banner" href="#"><span>
                            <img src="dev/img/banner/banner-17.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
            </div>
    ...
    <div class="new-product-area pad-60 pad-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
